...
\indent We discuss the value of $n_{i}$ in two situation between the rush hour and non peak time of the vehicle. A
\begin{equation}
	n_{i}=\begin{cases}
	&\frac{0.08Q}{3600t_{1}}\cdot\frac{l_{i}}{v_{i}} \indent\indent\indent \indent\quad\text{\,\,in the rush hour }\\ 
